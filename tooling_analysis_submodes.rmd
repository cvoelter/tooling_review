...
xx<-tooling.group.submode.ref%>%spread(frame_of_reference, sum_submode_tooling)%>%mutate(prop_ego=egocentric/(allocentric+egocentric), prop_allo=allocentric/(allocentric+egocentric))

write.csv(xx, file="prop_tooling_ref_frame.csv")
